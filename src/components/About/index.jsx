      ...
      <section className="section">
        <div className="container content">
          ...
          <div className={styles.paragraphs}>
            ...
            <p className="is-size-5">All the best,<br />Thomas Wicks</p>
            <hr />
            <p className="is-size-6">
              <strong>Disclaimer:</strong> This project is definitely not fool-proof. It should
              function perfectly fine under normal usage, but this web app
              should be seen as a personal project by an individual, not a
              production-ready note application with the absolute minimal chance
              of app-breaking bugs appearing.
            </p>
          </div>
        </div>
      </section>
